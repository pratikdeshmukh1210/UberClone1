...
export const createJourneySchema = z.object({
    body: z.object({
        ...
        pickupAddress: z
            ...
            .min(2, 'Pickup address must be at least 2 characters')
        ...
        dropoffAddress: z
            ...
            .min(2, 'Dropoff address must be at least 2 characters')
...
export const updateJourneyStatusSchema = z.object({
    body: z.object({
        status: z
            .enum(['ACCEPTED', 'ON_THE_WAY', 'COMPLETED', 'ARRIVED', 'STARTED'], {
