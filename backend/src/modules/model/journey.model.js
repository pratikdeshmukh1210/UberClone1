...
const journeySchema = new mongoose.Schema({
    ...
    status: {
        type: String,
        enum: {
            values: ['REQUESTED', 'ACCEPTED', 'ARRIVED', 'STARTED', 'ON_THE_WAY', 'COMPLETED', 'CANCELLED'],
    ...
    paymentMethod: {
        type: String,
        enum: ['CASH', 'CARD', 'UPI', 'WALLET', 'DIGITAL_WALLET', 'DEBIT_CARD', 'CREDIT_CARD'],
        default: 'CASH',
        required: false
    },
...
journeySchema.methods.isValidStatusTransition = function (newStatus) {
    const validTransitions = {
        ...
        'ACCEPTED': ['ARRIVED', 'ON_THE_WAY', 'STARTED', 'CANCELLED'],
        'ARRIVED': ['STARTED', 'ON_THE_WAY', 'CANCELLED'],
